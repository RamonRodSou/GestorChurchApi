INSERT INTO adults (
    first_name, last_name, birth_date, gender, cpf, email, phone, group_id,
    zip_code, street, house_number, city, state, neighborhood, civil_status,
    spouse_id, role, is_active, is_image_authorized, church_name, leader_name,
    baptism_date
) VALUES (
             'John', 'Doe', '1985-03-10', 'Male', '12345678901', 'john@example.com', '5511999999999', 'G1',
             '12345-678', 'Main Street', '100', 'Springfield', 'SP', 'Downtown', 'MARRIED','2',
...
INSERT INTO adults (
    ...
    role, is_active, is_image_authorized, church_name, leader_name, baptism_date
             ...
             'Jane', 'Smith', '1990-07-21', 'Female', '98765432100', 'jane@example.com', '5511888888888', 'G2',
...
INSERT INTO adults (
    ...
    role, is_active, is_image_authorized
             ...
             'Maria', 'Oliveira', '1995-01-15', 'Female', '55544433322', 'maria@example.com', '5511777777777', 'G3',
